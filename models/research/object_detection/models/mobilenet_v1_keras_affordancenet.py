...
from object_detection.models.keras_models import mobilenet_v1_m
from object_detection.utils import ops
from object_detection.utils import shape_utils


class AffordanceNetMobileNetV1KerasFeatureExtractor(
  ...
  def __init__(self,
    ...
    """
    super(AffordanceNetMobileNetV1KerasFeatureExtractor, self).__init__(
  ...
  def build(self, input_shape):
    full_mobilenet_v1_m = mobilenet_v1_m.mobilenet_v1_m(
        ...
        include_top=False)
    conv2d_11_pointwise = full_mobilenet_v1_m.get_layer(
        name='conv_pw_11_relu').output
    conv2d_13_pointwise = full_mobilenet_v1_m.get_layer(
        name='conv_pw_13_relu').output
    self.classification_backbone = tf.keras.Model(
        inputs=full_mobilenet_v1_m.inputs,
